...
class NoutsViewContoller: UIViewController {
    ...
    static  let screnSize = UIScreen.main.bounds // мы получаем размеры экраны(и нам пофиг какой это айфон)
    // ---------------------------------------------- \\
    ...
    [
        ServicesModel(image: "second", titile: "Бритье головы опасной бритвой", price: "1600"),
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.titleView = viewSource.segmentedController // добавил segmented вместо navigation title
        viewSource.segmentedController.selectedSegmentIndex = 1  // какой элемент segmented будет выбран по дефолту
